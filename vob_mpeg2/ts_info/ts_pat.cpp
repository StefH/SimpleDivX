...
int PATParser::AnalyzePAT(char *filename, 
						  int* pi_num_audio_streams, AUDIO_LIST* pr_audio_list,
						  int* pi_num_streams, STREAM_LIST* pr_stream_list)
{
	FILE *fin;
	unsigned char byte;
		...
		while ((read = fread(buffer, 1, 188, fin)) == 188)
		{
			...
			while (ndx < begin + length - 4)
			{
				...
				case 0x01:
					...
					pr_stream_list[*pi_num_streams].type = STREAM_TYPE_MPEG1_VIDEO;
					pr_stream_list[*pi_num_streams].id = pid;
					(*pi_num_streams)++;
					break;
				case 0x02:
					stream_type = "MPEG2 Video";
					pr_stream_list[*pi_num_streams].type = STREAM_TYPE_MPEG2_VIDEO;
					pr_stream_list[*pi_num_streams].id = pid;
					(*pi_num_streams)++;
					break;
				case 0x03:
					stream_type = "MPEG1 Audio";
					pr_audio_list[*pi_num_audio_streams].type = AUDIO_TYPE_MPEG1;
					pr_audio_list[*pi_num_audio_streams].id = pid;
					(*pi_num_audio_streams)++;
					break;
				case 0x04:
					stream_type = "MPEG2 Audio";
					pr_audio_list[*pi_num_audio_streams].type = AUDIO_TYPE_MPEG2;
					pr_audio_list[*pi_num_audio_streams].id = pid;
					(*pi_num_audio_streams)++;
					break;
				case 0x05:
					stream_type = "Private Sections";
					pr_stream_list[*pi_num_streams].type = STREAM_TYPE_PRIVATE;
					pr_stream_list[*pi_num_streams].id = pid;
					(*pi_num_streams)++;
					break;
				case 0x06:
				case 0x07:
					...
					pr_stream_list[*pi_num_streams].type = STREAM_TYPE_SUBTITLES;
					pr_stream_list[*pi_num_streams].id = pid;
					(*pi_num_streams)++;
					break;
				case 0x0f:
				case 0x11:
					...
					pr_audio_list[*pi_num_audio_streams].type = AUDIO_TYPE_AAC;
					pr_audio_list[*pi_num_audio_streams].id = pid;
					(*pi_num_audio_streams)++;
					break;
				case 0x81:
					stream_type = "AC3 Audio";
					pr_audio_list[*pi_num_audio_streams].type = AUDIO_TYPE_AC3;
					pr_audio_list[*pi_num_audio_streams].id = pid;
					(*pi_num_audio_streams)++;
					break;
				default:
