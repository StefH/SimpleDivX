	...
	switch (uMsg)
	{
		case BFFM_INITIALIZED:		// sent when the browse dialog box has finished initializing. 
		{
			...
			if (hwndTree)
			{
				...
				rectCancel.bottom = rectDlg.bottom - 10;
				rectCancel.top = rectCancel.bottom - h;
				rectCancel.right = rectDlg.right - 10;
				...
				rectOK.bottom = rectDlg.bottom - 10;
				...
				rectTree.top = 15;
				rectTree.left= 10;
				rectTree.bottom = rectOK.top - 15;
				rectTree.right = rectDlg.right - 10;
